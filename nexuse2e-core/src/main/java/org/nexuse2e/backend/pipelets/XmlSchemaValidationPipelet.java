...
public class XmlSchemaValidationPipelet extends AbstractPipelet {
    ...
    public XmlSchemaValidationPipelet() {
        ...
        parameterMap.put(SCHEMA_FILE_PATH, new ParameterDescriptor(ParameterType.STRING, "Schema file", "Path to the "
                + "schema file for XML validation", ""));
    ...
    public MessageContext processMessage(MessageContext messageContext) throws IllegalArgumentException,
        ...
        if (enabled != null && enabled.booleanValue() && !StringUtils.isEmpty(schemaFilePath)) {
            ...
            for (MessagePayloadPojo pojo : payloads) {
                ...
                tempFilePath = ServerPropertiesUtil.replacePayloadDependedValues(tempFilePath,
                        pojo.getSequenceNumber(), messageContext);
                ...
                if (schema == null) {
                    ...
                    try {
                        ...
                        throw new NexusException("Error reading XML Schema file: " + tempFilePath + ". Cause: " + e.getMessage());
                    }
                }
                ...
                try {
                    ...
                    throw new NexusException("XML validation error (Conversation Id: " + messageContext.getMessagePojo().getConversation().getConversationId() + ", Message Id: " + messageContext.getMessagePojo().getMessageId() + "): " + e.getMessage(), e);
                }
            }
        }
