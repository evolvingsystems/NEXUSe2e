...
public class ProtocolAdapter implements org.nexuse2e.messaging.ProtocolAdapter {
    ...
    public MessageContext createErrorAcknowledgement(Constants.ErrorMessageReasonCode reasonCode,
        ...
        //        }
        //
        //        errrorNotification.setMessageKey( new MessageKey( currentChoreographyId, currentConversationId,
        //        messageId,
        //                currentPartnerId ) );
        //        errrorNotification.setReferenceMessageId( currentMessageId );
        //
        //        List<CommunicationPartnerPojo> partners = Engine.getInstance().getCurrentConfiguration()
        //        .getPartners();
        ...
        //        }
        //
        //        errrorNotification.getCustomParameters().put( Constants.PROTOCOLSPECIFIC_TOIDTYPE, partner
        //        .getPartnerType() );
        //
        //        String from = null;
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.messaging.ProtocolAdapter#createErrorAcknowledgement(org.nexuse2e.messaging.Constants
     * .ErrorMessageReasonCode, org.nexuse2e.pojo.ChoreographyPojo, org.nexuse2e.messaging.MessageContext, java.util
     * .List)
     */
