...
public class HeaderSerializer extends AbstractPipelet {
    ...
    public MessageContext processMessage(MessageContext messageContext) throws NexusException {
        ...
        try {
            ...
            if ((messagePojo.getType() == Constants.INT_MESSAGE_TYPE_ACK) && (messagePojo.getHeaderData() != null) && (messagePojo.getHeaderData().length != 0)) {
                ...
                // BODY ATTRS ----------------------------------------------------------
                // soapBody.addAttribute(soapFactory.createName( "xsi:schemaLocation" ),"http://www.oasis-open.org/committees/ebxml-msg/schema/msg-header-2_0.xsd
                // http://www.oasis-open.org/committees/ebxml-msg/schema/msg-header-2_0.xsd" );
                ...
                String service =
                        messagePojo.getCustomParameters().get(Constants.PARAMETER_PREFIX_EBXML20 + Constants.PROTOCOLSPECIFIC_SERVICE);
                if (service == null) {
                ...
                if (ack) { // ack
                    ...
                    // soapManifest.addAttribute( soapFactory.createName( Constants.MUSTUNDERSTAND,Constants
                    // .EBXML_NAMESPACE_PREFIX, Constants.EBXML_NAMESPACE ),Constants.MUSTUNDERSTAND_VALUE );
    ...
    private void createManifestReference(SOAPFactory soapFactory, SOAPElement parent, String href, String id,
        ...
        // soapEl.addAttribute( soapFactory.createName( "id", Constants.EBXML_NAMESPACE_PREFIX, Constants
        // .EBXML_NAMESPACE ), id );
