...
public class ProtocolAdapter implements org.nexuse2e.messaging.ProtocolAdapter {
    ...
    public MessageContext createErrorAcknowledgement(ErrorMessageReasonCode reasonCode, ChoreographyPojo choreography
        ...
        errorNotification.getCustomParameters().put(Constants.PARAMETER_PREFIX_EBXML20 + Constants.PROTOCOLSPECIFIC_TOIDTYPE, (conv != null ? conv.getPartner().getPartnerIdType() : null));
