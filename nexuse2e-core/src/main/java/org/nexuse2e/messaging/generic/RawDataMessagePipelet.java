...
public class RawDataMessagePipelet extends AbstractPipelet {
    ...
    public RawDataMessagePipelet() {
        ...
        parameterMap.put(MIME_TYPE_PARAM_NAME, new ParameterDescriptor(ParameterType.STRING, "MIME type", "The MIME " +
                "type of the payload", "text/plain"));
        parameterMap.put(SET_CONTENT_ID, new ParameterDescriptor(ParameterType.BOOLEAN, "Set Content ID", "Flag " +
                "whether to set the content ID based on a custom parameter", Boolean.FALSE));
