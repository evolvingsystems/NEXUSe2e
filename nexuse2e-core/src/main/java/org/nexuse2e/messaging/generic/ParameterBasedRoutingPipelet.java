...
public class ParameterBasedRoutingPipelet extends AbstractPipelet {
    ...
    private static Logger LOG = LogManager.getLogger(ParameterBasedRoutingPipelet.class);
    ...
    public ParameterBasedRoutingPipelet() {
        ...
        parameterMap.put(ROUTING_DEFINITION, new ParameterDescriptor(ParameterType.STRING, "Flat File Definition " +
                "File", "Path to flat file definition file.", ""));
    }
    ...
    public MessageContext processMessage(MessageContext messageContext) throws IllegalArgumentException,
        ...
        if (partnerSpecific) {
            ...
            if (partnerId == null) {
                throw new NexusException("No partner ID found in custom parameters!" + messageContext.getMessagePojo().getCustomParameters());
            }
        ...
        for (MappingDefinition mappingDefinition : theMappingDefinitions.getMappingDefinitions()) {
            ...
            if (parameter != null) {
                ...
                LOG.error(new LogMessage("No customer parameter found with name: " + mappingDefinition.getXpath(),
    ...
    private PartnerSpecificConfigurations readPartnerSpecificConfigurations(String configFileName) {
        ...
        digester.addObjectCreate("PartnerSpecificConfigurations/PartnerSpecificConfiguration", "org.nexuse2e.backend" +
                ".pipelets.helper.PartnerSpecificConfiguration");
