...
public class XmlBaseConfigurationProvider implements BaseConfigurationProvider {
    ...
    public void createBaseConfiguration(List<ComponentPojo> components, List<ChoreographyPojo> choreographies,
                                        ...
                                        List<CertificatePojo> certificates, List<TRPPojo> trps, List<UserPojo> users,
                                        List<RolePojo> roles, List<LoggerPojo> loggers, List<MappingPojo> mappings) throws InstantiationException {
        ...
        if (source instanceof InputStream) {
            ...
            if (url == null || url.trim().length() == 0) {
                ...
                try {
                    ...
                    if (tempUrl.getProtocol().equalsIgnoreCase("file") && !file.startsWith("/") && !file.contains(":")) {
