...
public interface ConfigurationAccessService {
     ...
     * @return
     */
    public abstract List<PipelinePojo> getFrontendPipelinePojos(int type, Comparator<PipelinePojo> comparator);

    /**
     * @return
     */
    public abstract List<PipelinePojo> getBackendPipelinePojos(int type, Comparator<PipelinePojo> comparator);
     ...
     * @return
     */
    public abstract TRPPojo getTrpByProtocolVersionAndTransport(String protocol, String version, String transport);
     ...
     */
    public abstract PartnerPojo getPartnerByNxPartnerId(int nxPartnerId) throws NexusException;
     ...
     * @throws NexusException
     */
    public abstract ComponentPojo getComponentByNxComponentId(int nxComponentId) throws NexusException;
     ...
     * @throws NexusException
     */
    public abstract PartnerPojo getPartnerByPartnerId(String partnerId) throws NexusException;
     ...
     * @return
     */
    public abstract CertificatePojo getCertificateFromPartnerByNxCertificateId(PartnerPojo partner,
                                                                               int nxCertificateId);
     ...
     * @return
     */
    public abstract ConnectionPojo getConnectionFromPartnerByNxConnectionId(PartnerPojo partner, int nxConnectionId);

    /**
     * @return
     * @throws NexusException
     */
    public abstract List<ChoreographyPojo> getChoreographies() throws NexusException;
     ...
     * @throws NexusException
     */
    public abstract List<ComponentPojo> getComponents(ComponentType type, Comparator<ComponentPojo> comparator) throws NexusException;

    public abstract List<ComponentPojo> getPipelets(boolean frontend) throws NexusException;
     ...
     * @throws NexusException
     */
    public abstract List<PartnerPojo> getPartners(int type, Comparator<PartnerPojo> comparator) throws NexusException;
     ...
     * @throws NexusException
     */
    public abstract List<CertificatePojo> getCertificates(int type, Comparator<CertificatePojo> comparator) throws NexusException;
     ...
     * @throws NexusException
     */
    public abstract CertificatePojo getCertificateByName(int type, String name) throws NexusException;
     ...
     * @throws NexusException
     */
    public abstract CertificatePojo getCertificateByNxCertificateId(int type, int nxCertificateId) throws NexusException;
     ...
     * @throws NexusException
     */
    public abstract CertificatePojo getFirstCertificateByType(int type, boolean isUnique) throws NexusException;
     ...
     * @throws NexusException
     */
    public abstract ChoreographyPojo getChoreographyByChoreographyId(String choreographyId) throws NexusException;
     ...
     * @throws NexusException
     */
    public abstract ChoreographyPojo getChoreographyByNxChoreographyId(int nxChoreographyId) throws NexusException;
     ...
     * @return
     */
    public abstract ParticipantPojo getParticipantFromChoreographyByNxPartnerId(ChoreographyPojo choreography,
                                                                                int nxPartnerId);
     ...
     * @return
     */
    public abstract ActionPojo getActionFromChoreographyByNxActionId(ChoreographyPojo choreography, int nxActionId);
     ...
     * @return
     */
    public abstract ActionPojo getActionFromChoreographyByActionId(ChoreographyPojo choreography, String actionId);
     ...
     * @return
     */
    public abstract ParticipantPojo getParticipantFromChoreographyByPartner(ChoreographyPojo choreography,
                                                                            PartnerPojo partner);
     ...
     */
    public abstract void deleteChoreography(ChoreographyPojo choreography) throws ReferencedChoreographyException,
            NexusException;
     ...
     * @throws NexusException if something else went wrong.
     */
    public abstract void deletePartner(PartnerPojo partner) throws ReferencedPartnerException, NexusException;
     ...
     * @throws NexusException if something else went wrong.
     */
    public abstract void deleteConnection(ConnectionPojo connection) throws ReferencedConnectionException,
            NexusException;
     ...
     * @param pipeline
     */
    public abstract void updatePipeline(PipelinePojo pipeline) throws NexusException;
     ...
     * @throws NexusException if something else went wrong.
     */
    public abstract void deletePipeline(PipelinePojo pipeline) throws ReferencedPipelineException, NexusException;
     ...
     * already exists.
     */
    public abstract Service renameService(String oldName, String newName) throws NexusException;
     ...
     * @throws NexusException if something else went wrong.
     */
    public abstract void deleteCertificate(CertificatePojo certificate) throws ReferencedCertificateException,
            NexusException;
     ...
     * @throws NexusException if something else went wrong.
     */
    public abstract void deleteCertificates(Collection<CertificatePojo> certificates) throws NexusException,
     ...
     */
    public abstract void updateCertificate(CertificatePojo certificate) throws NexusException;
     ...
     * @return
     */
    public abstract List<MappingPojo> getMappings(Comparator<MappingPojo> comparator);
     ...
     * @return
     */
    public abstract MappingPojo getMappingByCategoryDirectionAndKey(String category, boolean left, String key);

    /**
     * @param mapping
     * @throws NexusException
     */
    public abstract void updateMapping(MappingPojo mapping) throws NexusException;

    /**
     * @param mapping
     */
    public abstract void updateMappings(List<MappingPojo> addMappings, List<MappingPojo> removeMappings) throws NexusException;

    /**
     * @param mapping
     * @throws NexusException
     */
    public abstract void deleteMapping(MappingPojo mapping) throws NexusException;

    /**
     * @param category any subsystem selects its own category id to avoid parameter naming conflicts. 
     * @param tag optional ability to separate different sets of parameters for the same category, e.g. for different
     *           instances.
     * @param descriptors
     * @return
     */
    public abstract Map<String, Object> getGenericParameters(String category, String tag, Map<String,
     ...
     */
    public abstract Object getGenericParameter(String category, String tag, ParameterType type, Object defaultValue);

    /**
     * @param category
     * @param tag
     * @param values Name, Value pairs you want to set. Values for missing descriptors are ingnored while changing
     *               configuration.
     * @param descriptors Map containing the matching ParameterDescriptors and Names, If there is no matching value
     *                    for one
     ...
     */
    public abstract void setGenericParameters(String category, String tag, Map<String, Object> values, Map<String,
     ...
     * @throws NexusException
     */
    public abstract void updateCertificates(List<CertificatePojo> certs) throws NexusException;
