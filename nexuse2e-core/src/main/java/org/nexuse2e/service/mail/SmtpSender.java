...
public class SmtpSender extends AbstractService implements SenderAware {
            ...
            if (useEncryption) {
                ...
                if (!certificates.isEmpty()) {
                    ...
                    if ((certPojo != null) && (serverCertX509 != null) && (privateKey != null)) {
                        ...
                        attributes.add(new SMIMEEncryptionKeyPreferenceAttribute(new IssuerAndSerialNumber(new X509Name(serverCertX509.getIssuerDN().getName()), serverCertX509.getSerialNumber())));
                        ...
                        CertStore certStore = CertStore.getInstance("Collection",
                                new CollectionCertStoreParameters(Collections.singletonList(serverCertX509)),
    ...
    public void fillParameterMap(Map<String, ParameterDescriptor> parameterMap) {
        ...
        parameterMap.put(HOST_PARAM_NAME, new ParameterDescriptor(ParameterType.STRING, "Host", "SMTP host name or IP" +
                " address", ""));
        parameterMap.put(PORT_PARAM_NAME, new ParameterDescriptor(ParameterType.STRING, "Port", "SMTP port number " +
                "(default is 25 or 465 for SSL)", "25"));
        parameterMap.put(TIMEOUT_PARAM_NAME, new ParameterDescriptor(ParameterType.STRING, "Timeout", "Connection and" +
                " I/O timeout in milliseconds (default is 10000)", "10000"));
        parameterMap.put(EMAIL_PARAM_NAME, new ParameterDescriptor(ParameterType.STRING, "Email", "Sender email " +
                "address", ""));
    ...
    public MessageContext sendMessage(MessageContext messageContext) throws NexusException {
        ...
        try {
            ...
            Object[] connectionInfo = connect((String) getParameter(HOST_PARAM_NAME),
                    ...
                    (String) getParameter(PORT_PARAM_NAME), (String) getParameter(TIMEOUT_PARAM_NAME));
