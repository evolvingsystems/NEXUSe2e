...
public class NEXUSe2eInterfaceImpl implements NEXUSe2eInterface {
    ...
    public String createConversation(String choreographyId, String businessPartnerId) throws NexusException {
        ...
        LOG.debug("createConversation - choreographyId: " + choreographyId + ", businessPartnerId: " + businessPartnerId);
        ConversationPojo conversationPojo =
                Engine.getInstance().getTransactionService().createConversation(choreographyId, businessPartnerId,
                        null);
        return conversationPojo.getConversationId();
    }

    /* (non-Javadoc)
     * @see org.nexuse2e.integration.NEXUSe2eInterface#createConversation(java.lang.String, java.lang.String, java
     * .lang.String)
     */
    public String createConversation(String choreographyId, String businessPartnerId, String conversationId) throws NexusException {

        checkExist(choreographyId, businessPartnerId, null);

        LOG.debug("createConversation - choreographyId: " + choreographyId + ", businessPartnerId: " + businessPartnerId + ", conversationId: " + conversationId);
        ConversationPojo conversationPojo =
                Engine.getInstance().getTransactionService().createConversation(choreographyId, businessPartnerId,
                        conversationId);
        return conversationPojo.getConversationId();
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.integration.NEXUSe2eInterface#triggerSendingMessage(java.lang.String, java.lang.String, java
     * .lang.Object)
     */
    public boolean triggerSendingMessage(String conversationId, String actionId, Object primaryKey) throws NexusException {
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.integration.NEXUSe2eInterface#sendStringMessage(java.lang.String, java.lang.String, java
     * .lang.String)
     */
    public boolean sendStringMessage(String conversationId, String actionId, String payload) throws NexusException {

        LOG.debug("sendMessage - conversationId: " + conversationId + ", actionId: " + actionId + ", primaryKey: " + payload);
        ...
        if (backendPipelineDispatcher != null) {
            try {
                backendPipelineDispatcher.processMessage(conversationId, actionId, null, payload == null ? null :
                        payload.getBytes());
            } catch (NexusException e) {
                LOG.debug("sendStringMessage - error: " + e);
                e.printStackTrace();
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.integration.NEXUSe2eInterface#triggerSendingNewMessage(java.lang.String, java.lang.String,
     ...
     */
    public String triggerSendingNewMessage(String choreographyId, String businessPartnerId, String actionId,
                                           String conversationId, String messageId, Object primaryKey) throws NexusException {
        checkExist(choreographyId, businessPartnerId, actionId);

        MessageContext messageContext = null;

        LOG.debug("Parameters - choreographyId: " + choreographyId + ", messageId: " + messageId + ", " +
                "businessPartnerId: " + businessPartnerId + ", actionId: " + actionId + ", primaryKey: " + primaryKey);
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.integration.NEXUSe2eInterface#sendNewStringMessage(java.lang.String, java.lang.String, java
     ...
     */
    public String sendNewStringMessage(String choreographyId, String businessPartnerId, String actionId,
                                       String conversationId, String messageId, String payload) throws NexusException {
        checkExist(choreographyId, businessPartnerId, actionId);

        LOG.debug("Parameters - choreographyId: " + choreographyId + ", messageId: " + messageId + ", " +
                "businessPartnerId: " + businessPartnerId + ", actionId: " + actionId + ", primaryKey: " + payload);
        ...
        if (backendPipelineDispatcher != null) {
            try {
                MessageContext messageContext = backendPipelineDispatcher.processMessage(businessPartnerId,
                        choreographyId, actionId, conversationId, messageId, null, null, (payload != null ?
                                payload.getBytes() : null));
     ...
     */
    protected void checkExist(String choreographyId, String businessPartnerId, String actionId) throws NexusException {
