...
public class TransactionServiceImpl implements TransactionService {
     ...
     */
    protected List<ConversationPojo> completeConversations(List<ConversationPojo> conversations,
                                                           boolean completeMessages) throws NexusException {
    ...
    protected ConversationPojo complete(ConversationPojo conversation, boolean completeMessages) throws NexusException {
        ...
        if (conversation.getCurrentAction() != null && conversation.getChoreography() != null) {
            ActionPojo currentAction = c.getActionFromChoreographyByNxActionId(conversation.getChoreography(),
                    conversation.getCurrentAction().getNxActionId());
    ...
    protected MessagePojo complete(MessagePojo message, boolean completeConversation) throws NexusException {
        ...
        if (message.getConversation() != null) {
            ActionPojo action = c.getActionFromChoreographyByNxActionId(message.getConversation().getChoreography(),
                    message.getAction().getNxActionId());
    ...
    public ConversationPojo createConversation(String choreographyId, String partnerId, String conversationId) throws NexusException {

        ConversationPojo conversationPojo = null;

        ChoreographyPojo choreography =
                Engine.getInstance().getActiveConfigurationAccessService().getChoreographyByChoreographyId(choreographyId);
        if (choreography == null) {
            throw new NexusException("No choreography found for choreography ID: " + choreographyId);
        }

        PartnerPojo partner =
                Engine.getInstance().getActiveConfigurationAccessService().getPartnerByPartnerId(partnerId);
        if (partner == null) {
    ...
    public ConversationPojo getConversation(int nxConversationId) throws NexusException {
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getConversationsForReport(java.lang.String, int, int, java
     * .lang.String, java.util.Date, java.util.Date, int, int, int, boolean)
     */
    public List<ConversationPojo> getConversationsForReport(String status, int nxChoreographyId, int nxPartnerId,
                                                            String conversationId, Date start, Date end,
                                                            int itemsPerPage, int page, int field, boolean ascending) throws NexusException {

        return completeConversations(getTransactionDao().getConversationsForReport(status, nxChoreographyId,
                nxPartnerId, conversationId, start, end, itemsPerPage, page, field, ascending), false);

    }


    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getConversationsCount(java.lang.String, int, int, java.lang
     * .String, java.util.Date, java.util.Date, int, boolean)
     */
    public int getConversationsCount(String status, int nxChoreographyId, int nxPartnerId, String conversationId,
        ...
        return getTransactionDao().getConversationsCount(status, nxChoreographyId, nxPartnerId, conversationId, start
                , end, field, ascending);
    }
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getMessagesForReport(java.lang.String, int, int, java.lang
     * .String, java.lang.String, java.lang.String, java.util.Date, java.util.Date, int, int, int, boolean)
     */
    public List<MessagePojo> getMessagesForReport(String status, int nxChoreographyId, int nxPartnerId,
                                                  String conversationId, String messageId, Integer type, Date start,
                                                  Date end, int itemsPerPage, int page, int field, boolean ascending) throws NexusException {

        return completeMessages(getTransactionDao().getMessagesForReport(status, nxChoreographyId, nxPartnerId,
                conversationId, messageId, type, start, end, itemsPerPage, page, field, ascending));
    }

    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getMessagesCount(java.lang.String, int, int, java.lang.String,
     *  java.lang.String, java.util.Date, java.util.Date)
     */
    public int getMessagesCount(String status, Integer type, int nxChoreographyId, int nxPartnerId,
                                String conversationId, String messageId, Date startDate, Date endDate) throws NexusException {

        return getTransactionDao().getMessagesCount(status, type, nxChoreographyId, nxPartnerId, conversationId,
                messageId, startDate, endDate);
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getNewMessage(java.lang.String, java.lang.String, java.lang
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#initializeMessage(org.nexuse2e.pojo.MessagePojo, java.lang
    ...
    public MessagePojo initializeMessage(MessagePojo message, String messageId, String conversationId,
        ...
        ParticipantPojo participant =
                Engine.getInstance().getActiveConfigurationAccessService().getParticipantFromChoreographyByPartner(choreography, partner);
        if (participant == null) {
        ...
        message.getCustomParameters().put(org.nexuse2e.messaging.ebxml.v20.Constants.PARAMETER_PREFIX_EBXML20 + org.nexuse2e.messaging.ebxml.v20.Constants.PROTOCOLSPECIFIC_FROM, senderId);
        message.getCustomParameters().put(org.nexuse2e.messaging.ebxml.v20.Constants.PARAMETER_PREFIX_EBXML20 + org.nexuse2e.messaging.ebxml.v20.Constants.PROTOCOLSPECIFIC_FROMIDTYPE, senderIdType);
        ...
        if (message.isNormal()) {
            action =
                    Engine.getInstance().getActiveConfigurationAccessService().getActionFromChoreographyByActionId(choreography, actionId);
            if (action == null) {
                throw new NexusException("No action found for actionId:" + actionId + " in choreography:" + choreography.getName());
            }
        ...
        String targetId =
                message.getCustomParameters().get(org.nexuse2e.messaging.ebxml.v20.Constants.PARAMETER_PREFIX_EBXML20 + org.nexuse2e.messaging.ebxml.v20.Constants.PROTOCOLSPECIFIC_TO);
    ...
    public MessageContext createMessageContext(MessagePojo messagePojo) {
        ...
        if (messagePojo != null) {
            ...
            //TODO refactor and standard constants
            messagePojo.getCustomParameters().put(org.nexuse2e.messaging.ebxml.v20.Constants.PARAMETER_PREFIX_EBXML20 + "from", senderId);
            messagePojo.getCustomParameters().put(org.nexuse2e.messaging.ebxml.v20.Constants.PARAMETER_PREFIX_EBXML20 + "fromIdType", senderIdType);
        }
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#storeTransaction(org.nexuse2e.pojo.ConversationPojo, org
     * .nexuse2e.pojo.MessagePojo)
     */
    public void storeTransaction(ConversationPojo conversationPojo, MessagePojo messagePojo) throws NexusException {
        ...
        if ((conversationPojo != null) && (messagePojo != null)) {
            LOG.debug(new LogMessage("storeTransaction: " + conversationPojo.getConversationId() + " - " + messagePojo.getMessageId(), messagePojo));
    ...
    public void updateTransaction(MessagePojo message, UpdateTransactionOperation operation) throws NexusException,
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#registerProcessingMessage(java.lang.String, java.util
     * .concurrent.ScheduledFuture)
     */
    public void registerProcessingMessage(MessagePojo message, ScheduledFuture<?> handle) {

        LOG.debug(new LogMessage("registerProcessingMessage: " + message.getMessageId(), "unknown",
    ...
    public void deregisterProcessingMessage(String id) {
        ...
        synchronized (processingMessages) {
            ...
            if (handle != null) {
                handle.cancel(false);
                if (LOG.isDebugEnabled()) {
                    LOG.debug(new LogMessage("deregisterProcessingMessage - processing cancelled with message status "
                            + MessagePojo.getStatusName(message.getStatus()) + "!", conversation, id));
                }
                processingMessages.remove(id);
            } else {
                if (LOG.isDebugEnabled()) {
                    LOG.debug(new LogMessage("No handle found when trying to deregister processing message: " + id,
                            conversation, id));
                }
            }
        }
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#deleteMessage(org.nexuse2e.pojo.MessagePojo, org.hibernate
     * .Session, org.hibernate.Transaction)
     */
     ...
     */
    public void deleteConversation(ConversationPojo conversation) throws NexusException {
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getMessagesByPartnerAndDirection(org.nexuse2e.pojo
     * .PartnerPojo, boolean, int, boolean, org.hibernate.Session, org.hibernate.Transaction)
     */
    public List<MessagePojo> getMessagesByPartnerAndDirection(PartnerPojo partner, boolean outbound, int sort,
        ...
        return completeMessages(getTransactionDao().getMessagesByPartnerAndDirection(partner, outbound, sort,
                ascending));
    }

    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getConversationsByPartner(org.nexuse2e.pojo.PartnerPojo, org
     * .hibernate.Session, org.hibernate.Transaction)
     */
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getConversationsByChoreography(org.nexuse2e.pojo
     * .ChoreographyPojo, org.hibernate.Session, org.hibernate.Transaction)
     */
    public List<ConversationPojo> getConversationsByChoreography(ChoreographyPojo choreography) throws NexusException {

        return completeConversations(getTransactionDao().getConversationsByChoreography(choreography), true);
    }

    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getConversationsByPartnerAndChoreography(org.nexuse2e.pojo
     * .PartnerPojo, org.nexuse2e.pojo.ChoreographyPojo, org.hibernate.Session, org.hibernate.Transaction)
     */
    public List<ConversationPojo> getConversationsByPartnerAndChoreography(PartnerPojo partner,
        ...
        return completeConversations(getTransactionDao().getConversationsByPartnerAndChoreography(partner,
                choreography), true);
    }

    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getMessagessByPartner(org.nexuse2e.pojo.PartnerPojo, org
     * .hibernate.Session, org.hibernate.Transaction)
     */
    public List<MessagePojo> getMessagesByPartner(PartnerPojo partner, int field, boolean ascending) throws NexusException {

        return completeMessages(getTransactionDao().getMessagesByPartner(partner, field, ascending));
    }

    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getMessagesByChoreographyAndPartner(org.nexuse2e.pojo
     * .ChoreographyPojo, org.nexuse2e.pojo.PartnerPojo, int, boolean, org.hibernate.Session, org.hibernate.Transaction)
     */
    public List<MessagePojo> getMessagesByChoreographyAndPartner(ChoreographyPojo choreography, PartnerPojo partner,
        ...
        return completeMessages(getTransactionDao().getMessagesByChoreographyAndPartner(choreography, partner, field,
                ascending));
    }

    public List<MessagePojo> getMessagesByActionPartnerDirectionAndStatus(ActionPojo action, PartnerPojo partner,
                                                                          boolean outbound, int status, int field,
                                                                          boolean ascending) throws NexusException {

        return completeMessages(getTransactionDao().getMessagesByActionPartnerDirectionAndStatus(action, partner,
                outbound, status, field, ascending));
    }


    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getMessagesByChoreographyPartnerAndConversation(org.nexuse2e
     * .pojo.ChoreographyPojo, org.nexuse2e.pojo.PartnerPojo, org.nexuse2e.pojo.ConversationPojo, int, boolean, org
     * .hibernate.Session, org.hibernate.Transaction)
     */
    public List<MessagePojo> getMessagesByChoreographyPartnerAndConversation(ChoreographyPojo choreography,
                                                                             PartnerPojo partner,
                                                                             ConversationPojo conversation, int field
            , boolean ascending) throws NexusException {

        return completeMessages(getTransactionDao().getMessagesByChoreographyPartnerAndConversation(choreography,
                partner, conversation, field, ascending));
    }

    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getLogEntriesForReportCount(java.lang.String, java.lang
     * .String, java.util.Date, java.util.Date, int, boolean)
     */
    public int getLogEntriesForReportCount(String severity, String messageText, Date start, Date end, int field,
                                           boolean ascending) throws NexusException {

        return getLogDao().getLogEntriesForReportCount(severity, messageText, start, end, field, ascending);
    }

    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getLogEntriesForReport(java.lang.String, java.lang.String,
     * java.lang.String, boolean)
     */
    public List<LogPojo> getLogEntriesForReport(String severity, String conversationId, String messageId,
                                                boolean ascending) throws NexusException {
    ...
    public List<LogPojo> getLogEntriesForReport(String severity, String conversationId, String messageId,
                                                int itemsPerPage, int page, boolean ascending) throws NexusException {
    ...
    /* (non-Javadoc)
     * @see org.nexuse2e.controller.TransactionService#getLogEntriesForReport(java.lang.String, java.lang.String,
     * java.util.Date, java.util.Date, int, int, int, boolean)
     */
    public List<LogPojo> getLogEntriesForReport(String severity, String messageText, Date start, Date end,
                                                int itemsPerPage, int page, int field, boolean ascending) throws NexusException {

        return getLogDao().getLogEntriesForReport(severity, messageText, start, end, itemsPerPage, page, field,
                ascending);
    }
