...
public class ConnectionPojo implements NEXUSe2ePojo {
    ...
    @Column(name = "tlsProtocols", nullable = true, length = 512)
    private String tlsProtocols;

    @Column(name = "tlsCiphers", nullable = true, length = 512)
    ...
    public Set<ParticipantPojo> getParticipants() {
        return participants;
    }

    public void setParticipants(Set<ParticipantPojo> participants) {
